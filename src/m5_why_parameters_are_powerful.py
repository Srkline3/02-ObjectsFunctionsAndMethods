...
def main():
    ...
    #better_draw_circles(rg.Point(0, 0), 5)
    #better_draw_circles(rg.Point(50, -50), 25)
    #even_better_draw_circles(rg.Point(-50, 0), 50, 3, 'red', 30)
    #even_better_draw_circles(rg.Point(0, -50), 5, 80, 'blue', 5)
    even_better_draw_circles(rg.Point(0, 10), 10, 30, 'light sea green', 25)
    even_better_draw_circles(rg.Point(0, -10), 10, 30, 'purple', 5)
    window.update()
...
def better_draw_circles(point, radial_factor):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radial_factor)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radial_factor * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, radial_factor, number_of_circles, color, thickness):
